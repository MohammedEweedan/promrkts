...
const HorizontalScrollPanel: React.FC<{
  title: string;
  subtitle?: string;
  panels: { title: string; content: React.ReactNode; icon?: string }[];
  mode: string;
}> = ({ title, subtitle, panels, mode }) => {
  const scrollContainerRef = React.useRef<HTMLDivElement | null>(null);
  const totalPanels = panels.length;
  const isDark = mode === "dark";
  const [activePanel, setActivePanel] = React.useState(0);

  // Handle scroll to update active panel
  const handleScroll = () => {
  ...
  // Color explosion gradients for each product
  const productColors = [
    "linear-gradient(135deg, rgba(101, 168, 191, 0.3), rgba(147, 51, 234, 0.2))", // Academy - blue/purple
    "linear-gradient(135deg, rgba(236, 72, 153, 0.3), rgba(251, 146, 60, 0.2))", // Subscriptions - pink/orange
    "linear-gradient(135deg, rgba(34, 197, 94, 0.3), rgba(59, 130, 246, 0.2))", // Challenges - green/blue
    "linear-gradient(135deg, rgba(251, 191, 36, 0.3), rgba(239, 68, 68, 0.2))", // Token - gold/red
  ];
    ...
    >
      ...
      >
        <HStack spacing={6}>
          <VStack spacing={0} align="start">
            <Text fontSize="xs" opacity={0.7} color={isDark ? "gray.300" : "gray.600"}>
              Active Traders
            </Text>
            <Text fontSize="sm" fontWeight="700" color={isDark ? "white" : "gray.900"}>
              101,402
            </Text>
          </VStack>
          <VStack spacing={0} align="start">
      ...
      >
        {panels.map((_, idx) => (
          <Box
            key={idx}
            w={activePanel === idx ? "26px" : "8px"}
            h="8px"
            borderRadius="full"
            bg={activePanel === idx ? UI.accent : isDark ? "whiteAlpha.300" : "blackAlpha.300"}
      ...
      >
        <HStack spacing={0} h="full">
          {panels.map((panel, idx) => (
            ...
            >
              <VStack spacing={8} maxW="600px" w="full" position="relative">
                {/* Color explosion background behind icon */}
                {panel.icon && (
                  <Box position="relative">
                    <Box
                      ...
                      h={{ base: "10px", md: "3px" }}
                      borderRadius="full"
                      bg={productColors[idx % productColors.length]}
                      filter="blur(60px)"
                      opacity={0.6}
                      zIndex={0}
                    />
          ...
          {isLoggedIn ? (
            ...
            <>
              ...
              <HorizontalScrollPanel
                title="A full trading ecosystem"
                subtitle="Courses, subscriptions, challenges, and token layer"
                mode={mode}
                panels={[
                  {
                    title: "Academy",
                    ...
                    content: (
                      <VStack spacing={6} w="full">
                        ...
                        >
                          Structured playbooks, live reviews, and risk frameworks built like a prop
                          desk.
                        </Text>
                        <Button
                          size="lg"
                          ...
                          _hover={{
                            ...
                            boxShadow: "0 0 60px rgba(0,191,99,0.4)",
                          }}
                    ...
                    content: (
                      <VStack spacing={6} w="full">
                        <Text
                          ...
                          color={mode === "dark" ? "gray.200" : "gray.700"}
                        >
                          Discord floor access, weekly setups, accountability, and trader psychology
                          routines.
                        </Text>
                        <Button
                          size="lg"
                    ...
                    content: (
                      <VStack spacing={6} w="full">
                        <Text
                          ...
                          color={mode === "dark" ? "gray.200" : "gray.700"}
                        >
                          Pass rules-based evaluations. Track drawdown, targets, and consistency
                          metrics.
                        </Text>
                        <Button
                          size="lg"
                    ...
                    content: (
                      <VStack spacing={6} w="full">
                        <Text
                          ...
                          color={mode === "dark" ? "gray.200" : "gray.700"}
                        >
                          Utility + rewards layer designed to integrate staking, access, and fee
                          benefits.
                        </Text>
                        <Button
                          size="lg"
              ...
              <Container maxW="container.xl">
                <AppleReveal offset={["start 95%", "end 40%"]}>
                  <FeaturePuzzle
                    title="Your trading toolkit"
                    subtitle="A puzzle of features you can customize with emojis, icons, and real screenshots."
                    mode={mode}
                    items={[
                      {
                        title: "Markets overview",
                        body: "Watchlists, movers, and key levels in one place.",
                        emoji: "📈",
                        colSpan: { md: 4 },
                      },
                      {
                        title: "AI setups",
                        body: "Signal summaries and narrative context — not noise.",
                        emoji: "🧠",
                        colSpan: { md: 4 },
                      },
                      {
                        title: "News timeline",
                        body: "Track catalysts and sessions with clean filtering.",
                        emoji: "🗞️",
                        colSpan: { md: 4 },
                      },
                      {
                        title: "Journal & reviews",
                        body: "Capture decisions, grade execution, and learn faster.",
                        emoji: "📝",
                        colSpan: { md: 7 },
                      },
                      {
                        title: "Prop-style challenges",
                        body: "Rules-first evaluation with clear drawdown and targets.",
                        emoji: "🏁",
                        colSpan: { md: 5 },
                      },
                    ]}
                ...
                <ParallaxSection speed={0.3}>
                  <AppleReveal>
                    <HomeSection
                      id="challenges"
                      title="Prop-style challenges"
                      subtitle="Rules-first evaluations built for discipline: drawdown, targets, and consistency."
                    >
                      ...
                      <Text mt={3} fontSize="sm" opacity={0.7}>
                        *Example structure — wire this to real backend terms when ready.
                      </Text>
                    </HomeSection>
                  </AppleReveal>
                </ParallaxSection>
                      ...
                      steps={[
                        {
                          ...
                          body: "No hidden constraints. Everything is stated up front.",
                        },
                        {
                          title: "Accountability tooling",
                          body: "Journals, reviews, and cadence that reduces mistakes.",
                        },
                        {
                          title: "Privacy-minded",
                          body: "Minimize stored data. Keep sensitive flows isolated.",
                        },
                      ]}
                    />
                  </AppleReveal>
