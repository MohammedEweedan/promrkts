  ...
  ur: {
    translation: {
      ...
      auth: {
        ...
        login_subtitle: 'پریمیم کورسز، منتخب سگنلز اور مخصوص سپورٹ تک رسائی حاصل کریں',
        login_cta: 'سائن ان کریں',
        no_account: 'اکاؤنٹ نہیں ہے؟',
        join_us: 'promrkts میں شامل ہوں',
        login_loading: 'سائن ان ہو رہا ہے...',
        login_error: 'لاگ ان ناکام',
        forgot_password: 'پاس ورڈ بھول گئے؟',
        remember_me: 'مجھے یاد رکھیں',
        register: 'اکاؤنٹ بنائیں',
        register_title: 'اپنا اکاؤنٹ بنائیں',
        register_error: 'رجسٹریشن ناکام',
        ...
        email_placeholder: 'you@example.com',
        password: 'پاس ورڈ',
        password_placeholder: '8+ حروف',
        password_confirm: 'پاس ورڈ کی تصدیق کریں',
        phone: 'فون',
        phone_placeholder: 'ملکی کوڈ کے بغیر نمبر درج کریں',
        verify_email_title: 'اپنا ای میل تصدیق کریں',
        verify_email_instructions: 'ہم نے آپ کے ای میل پر 6 ہندسوں کا کوڈ بھیجا ہے۔ براہ کرم ان باکس اور سپیم فولڈر چیک کریں۔',
        verify_email: 'تصدیق کریں',
        email_code_placeholder: '6 ہندسوں کا کوڈ درج کریں',
        email_verified: 'ای میل تصدیق شدہ',
        resend_email: 'دوبارہ بھیجیں',
        resend_in: 'دوبارہ بھیجیں',
        nationality: 'قومیت',
        nationality_placeholder: 'ملک منتخب کریں',
        contact_info: 'رابطہ کی معلومات',
        basic_info: 'بنیادی معلومات',
        additional_info: 'اضافی معلومات',
        accept_terms: 'میں شرائط و ضوابط قبول کرتا/کرتی ہوں',
        accept_disclaimer: 'میں دستبرداری قبول کرتا/کرتی ہوں',
        view_terms: 'شرائط دیکھیں',
        view_disclaimer: 'دستبرداری دیکھیں',
      },
      common: { close: 'بند کریں', save: 'محفوظ کریں', loading: 'لوڈ ہو رہا ہے...', confirm: 'تصدیق کریں' },
    }
  },
  ...
  de: {
    translation: {
      ...
      auth: {
        ...
        login_subtitle: 'Zugang zu Premium-Kursen, ausgewählten Signalen und dediziertem Support',
        login_cta: 'Anmelden',
        no_account: 'Kein Konto?',
        join_us: 'promrkts beitreten',
        ...
        password: 'Passwort',
        password_placeholder: '8+ Zeichen',
        password_confirm: 'Passwort bestätigen',
        phone: 'Telefon',
        phone_placeholder: 'Nummer ohne Ländervorwahl eingeben',
        verify_email_title: 'E-Mail bestätigen',
        verify_email_instructions: 'Wir haben einen 6-stelligen Code an Ihre E-Mail gesendet. Bitte überprüfen Sie Ihren Posteingang und Spam-Ordner.',
        verify_email: 'Bestätigen',
        email_code_placeholder: '6-stelligen Code eingeben',
        email_verified: 'E-Mail bestätigt',
        resend_email: 'Erneut senden',
        resend_in: 'Erneut senden in',
        nationality: 'Nationalität',
        nationality_placeholder: 'Land auswählen',
        contact_info: 'Kontaktinformationen',
        basic_info: 'Grundinformationen',
        additional_info: 'Zusätzliche Informationen',
        accept_terms: 'Ich akzeptiere die Allgemeinen Geschäftsbedingungen',
        accept_disclaimer: 'Ich akzeptiere den Haftungsausschluss',
        view_terms: 'Bedingungen anzeigen',
        view_disclaimer: 'Haftungsausschluss anzeigen',
      },
      common: { close: 'Schließen', save: 'Speichern', loading: 'Laden...', confirm: 'Bestätigen' },
    }
  },
  ...
  nl: {
    translation: {
      ...
      auth: {
        ...
        login_subtitle: 'Toegang tot premium cursussen, geselecteerde signalen en toegewijde ondersteuning',
        login_cta: 'Inloggen',
        no_account: 'Geen account?',
        join_us: 'Word lid van promrkts',
        ...
        already_have: 'Al een account?',
        have_account: 'Heeft u een account?',
        name: 'Naam',
        name_placeholder: 'Volledige naam',
        email: 'E-mail',
        email_placeholder: 'u@voorbeeld.com',
        password: 'Wachtwoord',
        password_placeholder: '8+ tekens',
        password_confirm: 'Wachtwoord bevestigen',
        phone: 'Telefoon',
        phone_placeholder: 'Voer nummer in zonder landcode',
        verify_email_title: 'Verifieer uw e-mail',
        verify_email_instructions: 'We hebben een 6-cijferige code naar uw e-mail gestuurd. Controleer uw inbox en spam-map.',
        verify_email: 'Verifiëren',
        email_code_placeholder: 'Voer 6-cijferige code in',
        email_verified: 'E-mail geverifieerd',
        resend_email: 'Opnieuw verzenden',
        resend_in: 'Opnieuw verzenden over',
        nationality: 'Nationaliteit',
        nationality_placeholder: 'Selecteer land',
        ...
        accept_disclaimer: 'Ik accepteer de Disclaimer',
        view_terms: 'Voorwaarden bekijken',
        view_disclaimer: 'Disclaimer bekijken',
      },
      common: { close: 'Sluiten', save: 'Opslaan', loading: 'Laden...', confirm: 'Bevestigen' },
    }
  }
};
